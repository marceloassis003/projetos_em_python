...
Este processo é chamado de serialização/desearilização

# OBS: O módulo Pickle não é seguro contra dados maliciosos e desta
forma não é recomendado trabalhar com arquivos pickle de outras pessoas
...
with open('animais.pickle', 'wb') as arquivo:
    pickle.dump((fellix, pluto), arquivo)
